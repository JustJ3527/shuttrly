    ...
    def save(self, *args, **kwargs):
        ...
        try:
            if self.pk:  # Only for existing users
                ...
                if old_user.profile_picture and old_user.profile_picture.name != 'profiles/default.jpg':
        ...
        if (old_profile_picture_path and 
            self.profile_picture and 
            old_profile_picture_path != self.profile_picture.name):
            ...
            print(f"🗓️ Scheduled deletion of old profile picture: {old_profile_picture_path}")
